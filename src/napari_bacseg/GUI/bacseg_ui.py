...
"                                    ")
        ...
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_60)
        self.export_channel_settings = QtWidgets.QComboBox(self.tab_18)
        self.export_channel_settings.setObjectName("export_channel_settings")
        self.export_channel_settings.addItem("")
        self.export_channel_settings.addItem("")
        self.export_channel_settings.addItem("")
        self.export_channel_settings.addItem("")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.export_channel_settings)
        ...
        self.export_channel.setItemText(0, "")
        self.export_channel.addItem("")
    ...
    def retranslateUi(self, tab_widget):
        ...
        self.label_60.setText(_translate("tab_widget", "Multi Channel Mode"))
        self.export_channel_settings.setItemText(0, _translate("tab_widget", "All Channels (Stack)"))
        self.export_channel_settings.setItemText(1, _translate("tab_widget", "All Channels (Horizontal Stack)"))
        self.export_channel_settings.setItemText(2, _translate("tab_widget", "All Channels (Vertical Stack)"))
        self.export_channel_settings.setItemText(3, _translate("tab_widget", "First Three Channels (RGB)"))
        self.export_channel.setItemText(1, _translate("tab_widget", "Multi Channel"))
