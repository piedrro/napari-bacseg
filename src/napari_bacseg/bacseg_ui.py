...
class Ui_tab_widget(object):
    def setupUi(self, tab_widget):
        ...
        self.scalebar_resolution = QtWidgets.QLineEdit(self.tab)
        ...
        self.overlay_filename = QtWidgets.QCheckBox(self.tab)
        ...
        self.alignment_channel = QtWidgets.QComboBox(self.tab)
