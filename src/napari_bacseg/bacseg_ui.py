...
"                                    ")
        ...
        self.formLayout_28.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_114)
        ...
        self.picasso_vis_mode.addItem("")
        self.formLayout_28.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.picasso_vis_mode)
        self.label_115 = QtWidgets.QLabel(self.tab_13)
        self.label_115.setObjectName("label_115")
        self.formLayout_28.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_115)
        ...
        self.picasso_vis_size.addItem("")
        self.picasso_vis_size.addItem("")
        self.formLayout_28.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.picasso_vis_size)
        self.verticalLayout_16.addLayout(self.formLayout_28)
    ...
    def retranslateUi(self, tab_widget):
        ...
        self.picasso_box_size.setItemText(0, _translate("tab_widget", "3"))
        self.picasso_box_size.setItemText(1, _translate("tab_widget", "5"))
        self.picasso_box_size.setItemText(2, _translate("tab_widget", "7"))
        self.label_110.setText(_translate("tab_widget", "Min Net Gradient"))
        self.picasso_min_net_gradient.setText(_translate("tab_widget", "100"))
        ...
        self.label_113.setText(_translate("tab_widget", "Picasso Visulasation Settings"))
        self.label_114.setText(_translate("tab_widget", "Visualisation Mode"))
        self.picasso_vis_mode.setItemText(0, _translate("tab_widget", "Box"))
        self.picasso_vis_mode.setItemText(1, _translate("tab_widget", "Spot"))
        self.label_115.setText(_translate("tab_widget", "Visualisation Size"))
        self.picasso_vis_size.setItemText(0, _translate("tab_widget", "1"))
        self.picasso_vis_size.setItemText(1, _translate("tab_widget", "2"))
        self.picasso_vis_size.setItemText(2, _translate("tab_widget", "3"))
        self.picasso_vis_size.setItemText(3, _translate("tab_widget", "4"))
        self.picasso_vis_size.setItemText(4, _translate("tab_widget", "5"))
