...
"color: rgb(0, 255, 0);")
    ...
    def retranslateUi(self, tab_widget):
        ...
        self.zoom_magnification.setItemText(4, _translate("tab_widget", "50"))
        self.zoom_magnification.setItemText(5, _translate("tab_widget", "100"))
        self.zoom_magnification.setItemText(6, _translate("tab_widget", "200"))
